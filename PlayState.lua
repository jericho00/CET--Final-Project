...
function PlayState:render()
    ...
    love.graphics.printf(tostring(self.player.score), WINDOW_WIDTH / 8.8, 1, VIRTUAL_WIDTH / 4, 'center')
    love.graphics.setColor(255, 255, 255, 255)
    love.graphics.printf(tostring(self.player.score), WINDOW_WIDTH / 8.8, 1, VIRTUAL_WIDTH / 4,  'center')

    love.graphics.printf('Timer:'.. tostring(TIMERS), WINDOW_WIDTH/5,1,VIRTUAL_WIDTH/4,'right')
end